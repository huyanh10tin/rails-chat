...
times = (2..49).to_a
times.each_with_index do |times, idx|
  idx += 2
  a = Conversation.create!
  UserConversation.create! user_id: 1, conversation_id: a.id
  UserConversation.create! user_id: idx, conversation_id: a.id
  a = Conversation.last.messages.build body: Faker::Lorem.paragraph(1, true, 3), user_id: idx
  a.save
end
